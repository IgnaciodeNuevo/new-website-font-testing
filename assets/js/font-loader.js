...
// https://github.com/zachleat/zachleat.com/blob/master/web/js/fonts.js
// https://github.com/zachleat/zachleat.com/blob/master/web/js/fonts-polyfill-fontfaceonload.js
// (function() {
//     if ('fonts' in document || (sessionStorage.webfontStageOne && sessionStorage.webfontStageTwo)) {
//         return;
//     }
...
//         htmlDocument.classList.add('webfont-stage-1');
//         sessionStorage.webfontStageOne = true;

//         Promise.all([
//             document.fonts.load('700 1em DINNextBold'),
//             document.fonts.load('1em CiutadellaRegular'),
//         ]).then(function() {
//             htmlDocument.classList.add('webfont-stage-2');
//             sessionStorage.webfontStageTwo = true;
//         });
//     });
// })(document);
